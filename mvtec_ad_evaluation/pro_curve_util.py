...
def main2():
    ...
    label = cv2.imread('C:\\Users\\IntekPlus\\Desktop\\vscode\\MVTec_AD\\dataset\\mvtec_anomaly_detection\\capsule\\ground_truth\\crack\\000_mask.png', cv2.IMREAD_GRAYSCALE)
    label = label / 255.0
    labels.append(label)
    labels.append(label)
    labels.append(label)
